function(setup_linker target)
  if(${CMAKE_CXX_COMPILER_ID} MATCHES Clang)
    ...
    if(LLD)
      message(STATUS "found lld, using it as linker for target ${target}")
      target_link_options(${target} PUBLIC -fuse-ld=lld)
    elseif(CMAKE_BUILD_TYPE MATCHES "Release")
      message(FATAL_ERROR "LLD linker must be installed for building in Release mode with clang.")
    else()
      message(STATUS "LLD not available, using the system linker for taget ${taget}.")
    endif()
  endif()
  ...
  if(${CMAKE_CXX_COMPILER_ID} MATCHES GNU)
    ...
    elseif(CMAKE_BUILD_TYPE MATCHES "Release")
      message(FATAL_ERROR "Gold linker must be installed for building in Release mode with gcc.")
    else()
